...
class FoscamAccessory {
    constructor(hap, config, log) {
        ...
        self._createStreamControllers(2, mainURI, gain, mainOptions, self.setMainOptions.bind(self));
        self._createStreamControllers(2, subURI, gain, subOptions, self.setSubOptions.bind(self));
