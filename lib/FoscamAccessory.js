...
class FoscamAccessory {
    constructor(hap, config, log) {
        ...
        let maxMainStreams = config.maxMainStreams || 2;
        let maxSubStreams = config.maxSubStreams || 2;
        ...
        self._createStreamControllers(maxMainStreams, mainURI, gain, mainOptions, self.setMainOptions.bind(self));
        self._createStreamControllers(maxSubStreams, subURI, gain, subOptions, self.setSubOptions.bind(self));
